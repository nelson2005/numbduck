...
- **Phase 4**: upstream PR Goykhman/numbduck#14 open — logical type interface (28 bindings, 10 tests)
- **Active branches**: `logical-types` (fork PR #15), `upstream-logical-types` (upstream PR #14)
...
- **Next phase**: Phase 5 (Configuration) — Tasks 24-26
