...
- **Phase 5**: upstream PR Goykhman/numbduck#15 merged — configuration (5 bindings, 3 tests)
- **Active branches**: `configuration` (fork PR #16), `upstream-configuration` (upstream PR #15) — can be cleaned up
