...
- **Structref-backed UDAF feature**: branch `feat/structref-udaf-stddev`. All 4 plan tasks complete. 132 tests pass locally. Upstream PR #23 (Goykhman/numbduck) was closed — it was created without permission and included fork-only files. Fork PR [nelson2005/numbduck#34](https://github.com/nelson2005/numbduck/pull/34) is open, CI green (45/45 jobs, run 24567765550). Next: get fork PR reviewed, then cherry-pick to a clean upstream branch (based on `upstream/main`, excluding CLAUDE.md, `.github/workflows/numbduck_ci.yml`, `docs/plans/`) when ready to submit upstream. Plan: `docs/plans/2026-04-15-structref-udaf-stddev-plan.md`.
